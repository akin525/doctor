    ...
    <div class="container-xxl">
        ...
        <div class="row g-4 mb-4">
            <div class="col-lg-4 d-none d-lg-block">
                <div class="card shadow-sm h-100 p-4 d-flex align-items-center justify-content-center">
                    {{-- Eye Clinic Illustration --}}
{{--                    <img src="{{ asset('assets/images/clinic-illustration.svg') }}" alt="Clinic Illustration" class="img-fluid" style="max-height: 300px;">--}}
            ...
            <div class="col-lg-8">
                <div class="card shadow-sm">
                    <div class="card-header bg-primary text-white">
                        <h5 class="mb-0">Patient Statistics Overview</h5>
                    </div>
                    <div class="card-body">
        ...
        <div class="row g-4 mb-4">
            <div class="col-xl-6">
                <div class="card shadow-sm">
                    <div class="card-header bg-light">
                        <h6 class="mb-0 fw-bold text-primary">Hospital Status Summary</h6>
                    </div>
                    <div class="card-body">
                        <div class="row text-center">
                            <div class="col-4">
                                <i class="icofont-patient-file fs-1 text-info"></i>
                                <h6 class="mt-2">Appointments</h6>
                                <p class="mb-0">{{ number_format($total_appointment) }}</p>
                            </div>
                            <div class="col-4">
                                <i class="icofont-crutch fs-1 text-success"></i>
                                <h6 class="mt-2">Patients</h6>
                                <p class="mb-0">{{ number_format($total_patient) }}</p>
                            </div>
                            <div class="col-4">
                                <i class="icofont-doctor-alt fs-1 text-warning"></i>
                                <h6 class="mt-2">Doctors</h6>
                                <p class="mb-0">{{ number_format($total_doctor) }}</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-xl-6">
                <div class="card shadow-sm">
                    <div class="card-header bg-light">
                        <h6 class="mb-0 fw-bold text-primary">Room Booking Status</h6>
                    </div>
                    <div class="card-body">
                        <div class="row g-3">
                            @foreach(['A-101' => true, 'B-102' => false, 'C-103' => false, 'Occupied' => null] as $room => $available)
                                <div class="col-6 col-md-3">
                                    <label class="form-check-label d-block p-3 border rounded text-center {{ is_null($available) ? 'bg-light text-muted' : '' }}">
                                        <i class="icofont-patient-bed fs-3 d-block mb-1"></i>
                                        <input type="checkbox" class="form-check-input" {{ is_null($available) ? 'disabled' : '' }} {{ $available ? 'checked' : '' }}>
                                        <span class="d-block small">{{ $room }}</span>
                                    </label>
                                </div>
                            @endforeach
                        </div>
        ...
        <!-- ADMISSION & PATIENTS TABLE -->
        <div class="row g-4 mb-4">
            <div class="col-xl-8">
                <div class="card shadow-sm mb-3">
                    <div class="card-header bg-light">
                        <h6 class="mb-0 fw-bold text-primary">Admissions by Division</h6>
                    </div>
                    <div class="card-body">
                ...
                <div class="card shadow-sm">
                    <div class="card-header bg-light">
                        <h6 class="mb-0 fw-bold text-primary">Patients Table</h6>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-hover align-middle">
                                ...
                                @forelse($pap as $pa)
                                    <tr>
                                        <td><img src="{{ asset('assets/images/xs/avatar3.jpg') }}" class="avatar sm rounded-circle me-2" alt="profile"><span>{{ $pa['lastname'] }}</span></td>
                                        <td>{{ $pa['address'] }}</td>
                                        <td>{{ $pa['admited'] }}</td>
                                        <td>{{ $pa['discharge'] }}</td>
                                        <td>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="6" class="text-center text-muted">No patient data available.</td>
                                    </tr>
                                @endforelse
                                </tbody>
                            </table>
            ...
            <div class="col-xl-4">
                <div class="card shadow-sm">
                    <div class="card-header bg-light">
                        <h6 class="mb-0 fw-bold text-primary">Schedule Appointment</h6>
                    </div>
                    <div class="card-body">
                        <form>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                <select class="form-select">
                                    ...
                                    <option value="2">Dr. Adams</option>
                                </select>
                            </div>
