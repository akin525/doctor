                            ...
                            <div class="col-md-4 col-sm-6">
                                <div class="card">
                                    <div class="card-body ">
                                        ...
                                        <span class="text-muted">{{ number_format($total_appointment) }}</span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4 col-sm-6">
                                <div class="card">
                                    <div class="card-body ">
                                        ...
                                        <span class="text-muted">{{ number_format($total_patient) }}</span>
                                    </div>
                                </div>
                            </div>
{{--                            <div class="col-md-4 col-sm-6">--}}
...
{{--                                        <span class="text-muted">{{ number_format($patientsByDoctor) }}</span>--}}
{{--                                    </div>--}}
{{--                                </div>--}}
{{--                            </div>--}}
                            <div class="col-md-4 col-sm-6">
                                <div class="card">
                                    <div class="card-body ">
                                        ...
                                        <span class="text-muted">{{ number_format($total_doctor) }}</span>
                                    </div>
                                </div>
                            </div>
        ...
        const patientChart = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    fill: true,
                    backgroundColor: 'rgba(102, 153, 153, 0.3)',
                    borderColor: '#669999',
                    // tension: 0.3
                }]
            },
            ...
            data: {
                ...
                datasets: [
                        @foreach($chartData as $dataset)
                    {
                        ...
                        backgroundColor: {
                            'Cardiologist': 'rgba(75, 192, 192, 0.8)',
                            'Physician': 'rgba(255, 159, 64, 0.8)',
                            'Neurologist': 'rgba(153, 102, 255, 0.8)',
                            'Orthopedic': 'rgba(54, 162, 235, 0.8)'
                        }['{{ $dataset['label'] }}'],
                        stack: 'Stack 0'
                    },
                    @endforeach
