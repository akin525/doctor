...
<!-- Mirrored from pixelwibes.com/template/ihealth/html/dist/ui-elements/auth-signup.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 17 Jul 2025 18:10:09 GMT -->
<head>
    <meta charset="utf-8">
...
{{--                                </div>--}}
                                ...
                                <div class="col-12 text-center mt-4">
                                    <span>Already have an account? <a href="{{route('login')}}" title="Sign in" >Sign in here</a></span>
                                </div>
                            </form>
                            <!-- End Form -->
