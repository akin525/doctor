...
<!-- Mirrored from pixelwibes.com/template/ihealth/html/dist/ui-elements/auth-signin.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 17 Jul 2025 18:10:07 GMT -->
<head>
    <meta charset="utf-8">
...
{{--                                <i class="icofont-heart-beat secondary-color" style="font-size: 90px;"></i>--}}
                                <img width="200" src="clini.jpg" alt="login-img">
                            </div>
                            <div class="mb-5">
                                <h2 class="color-900 text-center">Central Vision EHR, We aim to make your life better</h2>
                            </div>
                            <!-- Image block -->
                            <div class="">
...
{{--                                </div>--}}
                                ...
                                <div class="col-12 text-center mt-4">
                                    <span>Don't have an account yet? <a href="{{route('register')}}" >Sign up here</a></span>
                                </div>
                            </form>
                            <!-- End Form -->
...
<!-- Mirrored from pixelwibes.com/template/ihealth/html/dist/ui-elements/auth-signin.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 17 Jul 2025 18:10:09 GMT -->
</html>
